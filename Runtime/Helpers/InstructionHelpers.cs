...
{
    public static void AssertType(Variable variable, Type expectedType)
    {
    ...
    public static void AssertSameType(Variable[] variables, Type? expectedType = null)
    {
    ...
    public static Type ExpectTypeParameter(string[] parameters, bool allowMore = false)
    {
    ...
    public static void AssertOneParameter(string[] parameters, Type? expectedType = null)
    {
